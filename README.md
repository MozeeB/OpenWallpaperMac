...
| **Rotation** | Command-click several wallpapers and rotate them every 5 s to 1 h, in order or shuffled, on all displays or a specific one; each display can run its own rotation, switches cross-fade and pause with playback |
